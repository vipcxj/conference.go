...
func (c *WebsocketClient) Join(timeout time.Duration, rooms ...string) error {
	return c.signal.Join(timeout, rooms...)
}

func (c *WebsocketClient) Leave(timeout time.Duration, rooms ...string) error {
	return c.signal.Join(timeout, rooms...)
}